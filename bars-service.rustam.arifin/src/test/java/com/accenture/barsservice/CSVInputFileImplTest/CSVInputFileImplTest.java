package com.accenture.barsservice.CSVInputFileImplTest;
...
public class CSVInputFileImplTest {
	...
	public void readInvalidRequest() throws IOException,BarsException {
		String filePath = "C:/BARS_TEST/billing-cycle-not-on-range-csv.csv";
		InputFileFactory factory = InputFileFactory.getInstance();
		File file = new File(filePath);
	...
	public void readInvalidRequestStartDate() throws IOException,BarsException {
		String filePath = "C:/BARS_TEST/invalid-start-date-csv.csv";
		InputFileFactory factory = InputFileFactory.getInstance();
		File file = new File(filePath);
		AbstractInputFile txtInputFile = factory.getInputFile(file);
		assertTrue(txtInputFile instanceof CSVInputFileImpl);
